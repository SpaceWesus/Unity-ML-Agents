...
public class PrometeoEditor : Editor{
  ...
  // ML AGENT
  private SerializedProperty useAgentInput;
  ...
  private void OnEnable(){
    ...
    // ML AGENT 
    useAgentInput = SO.FindProperty("useAgentInput");
  ...
  public override void OnInspectorGUI(){
    ...
    EditorGUILayout.PropertyField(useAgentInput, new GUIContent("Use External ML Agent Input?"));
